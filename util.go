...
// HtmlWriter function
type HtmlWriter func(io.Writer, string, string, interface{}) error
...
func htmlWriter(w io.Writer, path string, method string, v interface{}) error {
	if _htmlWriter != nil {
		return _htmlWriter(w, path, method, v)
	}
