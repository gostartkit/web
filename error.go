...
var (
	...
	ErrMovedPermanently = errors.New("MOVEDPERMANENTLY")
	...
	ErrTemporaryRedirect = errors.New("TEMPORARYREDIRECT")
	...
	ErrContentType = errors.New("CONTENTTYPENOTSUPPORTED")
	...
	ErrCors = errors.New("CROSSORIGINREQUESTBLOCKED")
	...
	ErrNotVerified = errors.New("NOTVERIFIED")
	...
	ErrServerNotInitialized = errors.New("SERVERNOTINITIALIZED")
)
